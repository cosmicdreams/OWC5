 ...
 */
?>
<div id="<?php print $block_html_id; ?>" class="tagline_wrap<?php print $classes; ?>"<?php print $attributes; ?>>

  <?php print render($title_prefix); ?>
  <?php if ($title): ?>
    <h2 class="tagline_headline"<?php print $title_attributes; ?>><?php print $title; ?></h2>
  <?php endif; ?>
