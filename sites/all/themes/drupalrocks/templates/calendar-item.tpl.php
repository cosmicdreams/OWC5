...
<div class="<?php print !empty($item->class) ? $item->class : 'item'; ?>">
  ...
  <div class="calendar <?php print $item->granularity; ?>view" style="background: <?php print $item->rendered_fields['field_color']; ?>">
    ...
    <?php else : ?>
    <div class="cutoff" style="background: <?php print $item->rendered_fields['field_color']; ?>">&nbsp;</div>
    <?php endif;?>
  </div> 
  </div>   
</div>
